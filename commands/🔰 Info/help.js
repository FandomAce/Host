...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("912131594112868402").setLabel("Support").setURL("https://discord.gg/64RrErRvRV")
      let menuOptions = [{
          label: "Overview",
          value: "Overview",
...
:video_game: A unique Music Request System and way much more! Economy! Moderation and much more comming!`)
        .addField("**__Music__**\n",
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**
   Made by [**FandomAce**](https://discord.gg/64RrErRvRV)`)
